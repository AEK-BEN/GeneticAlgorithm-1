...
if __name__=='__main__':
    ...
    nNodes = 12;    # The number of nodes in the graph. Remember, TSP is of exponential difficulty!
    ...
    p  = Core.Population(schema=ch, popSize=200, genSize=200, maximize=maximize, mutation_probability=0.5)
